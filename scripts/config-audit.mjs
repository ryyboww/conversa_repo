...
for (const mailbox of ['ryan@converastrategies.com','hello@converastrategies.com','help@converastrategies.com','admin@converastrategies.com']) add(`Branded mailbox declared: ${mailbox.split('@')[0]}`, site.includes(mailbox), mailbox);
